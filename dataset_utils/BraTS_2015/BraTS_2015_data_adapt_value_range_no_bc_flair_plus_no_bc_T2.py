...
folders = ["/media/fabian/My Book/datasets/BraTS/2015/train/HGG_npy/brain_only/", "/media/fabian/My Book/datasets/BraTS/2015/train/LGG_npy/brain_only/", "/media/fabian/My Book/datasets/BraTS/2015/test_npy/brain_only/"]
folders_out = ["/media/fabian/My Book/datasets/BraTS/2015/train/HGG_npy/brain_only/adapted_value_range", "/media/fabian/My Book/datasets/BraTS/2015/train/LGG_npy/brain_only/adapted_value_range", "/media/fabian/My Book/datasets/BraTS/2015/test_npy/brain_only/adapted_value_range"]
folders_out2 = ["/media/fabian/My Book/datasets/BraTS/2015/train/HGG_npy/brain_only/original_value_range", "/media/fabian/My Book/datasets/BraTS/2015/train/LGG_npy/brain_only/original_value_range", "/media/fabian/My Book/datasets/BraTS/2015/test_npy/brain_only/original_value_range"]
...
for folder, folder_out, folder_out2 in zip(folders, folders_out, folders_out2):
    ...
    for id in range(300):
        ...
        percentile_actual = [np.percentile(t1c_img[t1c_img!=t1c_img[0,0,0]].ravel(), lower_percentile), np.percentile(t1c_img[t1c_img!=t1c_img[0,0,0]].ravel(), upper_percentile)]
        ...
        percentile_actual = [np.percentile(t2_img[t2_img!=t2_img[0,0,0]].ravel(), lower_percentile), np.percentile(t2_img[t2_img!=t2_img[0,0,0]].ravel(), upper_percentile)]
        ...
        percentile_actual = [np.percentile(t2_no_bc_img[t2_no_bc_img!=t2_no_bc_img[0,0,0]].ravel(), lower_percentile), np.percentile(t2_no_bc_img[t2_no_bc_img!=t2_no_bc_img[0,0,0]].ravel(), upper_percentile)]
