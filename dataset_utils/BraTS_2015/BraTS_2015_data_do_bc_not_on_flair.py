...
HGG_folder = "/media/fabian/My Book/datasets/BraTS/2015/train/HGG_nifti/"
input_files = []
output_files = []
for id in range(999):
...
LGG_folder = "/media/fabian/My Book/datasets/BraTS/2015/train/LGG_nifti/"
input_files = []
output_files = []
for id in range(999):
...
test_folder = "/media/fabian/My Book/datasets/BraTS/2015/test_nifti"
input_files = []
output_files = []
for id in range(999):
