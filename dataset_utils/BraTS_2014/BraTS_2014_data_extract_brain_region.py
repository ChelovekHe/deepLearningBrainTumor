...
folder = "/media/fabian/My Book/datasets/BraTS/2014/train/HGG/npy/"
folder_out = "/media/fabian/My Book/datasets/BraTS/2014/train/HGG/npy/brain_only"
...
for id in np.arange(300):
    ...
    np.save(path.join(folder_out, "%03.0d_Flair_bc_ws.npy"%id), flair_img)
...
folder = "/media/fabian/My Book/datasets/BraTS/2014/train/LGG/npy/"
folder_out = "/media/fabian/My Book/datasets/BraTS/2014/train/LGG/npy/brain_only"
...
folder = "/media/fabian/My Book/datasets/BraTS/2014/test/npy/"
folder_out = "/media/fabian/My Book/datasets/BraTS/2014/test/npy/brain_only"
