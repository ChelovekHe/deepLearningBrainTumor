...
for id in np.arange(300):
    ...
    np.save(path.join(folder_out, "%03.0d_T2_ws.npy"%id), t2_img)
    np.save(path.join(folder_out, "%03.0d_T1c_ws.npy"%id), t1c_img)
    np.save(path.join(folder_out, "%03.0d_T1_ws.npy"%id), t1_img)
