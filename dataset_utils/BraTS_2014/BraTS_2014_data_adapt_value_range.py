...
folders_out = ["/media/fabian/My Book/datasets/BraTS/2014/train/HGG/npy/brain_only/adapted_value_range", "/media/fabian/My Book/datasets/BraTS/2014/train/LGG/npy/brain_only/adapted_value_range", "/media/fabian/My Book/datasets/BraTS/2014/test/npy/brain_only/adapted_value_range"]
folders_out2 = ["/media/fabian/My Book/datasets/BraTS/2014/train/HGG/npy/brain_only/original_value_range", "/media/fabian/My Book/datasets/BraTS/2014/train/LGG/npy/brain_only/original_value_range", "/media/fabian/My Book/datasets/BraTS/2014/test/npy/brain_only/original_value_range"]
...
for folder, folder_out, folder_out2 in zip(folders, folders_out, folders_out2):
    ...
    for id in range(300):
        if not path.isfile(path.join(folder, "%03.0d_Flair_bc_ws.npy"%id)):
            continue
        ...
        flair_img = np.load(path.join(folder, "%03.0d_Flair_bc_ws.npy"%id))
