...
def build_net():
    ...
    net['conv_1_1'] = ConvLayer(net['batchNorm'], 16, 7, pad='same', stride=1, nonlinearity=lasagne.nonlinearities.elu)
    net['conv_1_1_do'] = DropoutLayer(net['conv_1_1'], p=0.2)
    net['maxPool_1_1'] = Pool2DLayer(net['conv_1_1_do'], 2, mode='max')

    net['conv_1_2'] = ConvLayer(net['maxPool_1_1'], 16, 5, pad='same', stride=1, nonlinearity=lasagne.nonlinearities.elu)
    net['conv_1_2_do'] = DropoutLayer(net['conv_1_2'], p=0.2)
    net['maxPool_1_2'] = Pool2DLayer(net['conv_1_2_do'], 2, mode='max')


    net['conv_2_1'] = ConvLayer(net['maxPool_1_2'], 32, 3, pad='same', stride=1, nonlinearity=lasagne.nonlinearities.elu)
    net['conv_2_1_do'] = DropoutLayer(net['conv_2_1'], p=0.3)
    net['maxPool_2_1'] = Pool2DLayer(net['conv_2_1_do'], 2, mode='max')

    net['conv_2_2'] = ConvLayer(net['maxPool_2_1'], 32, 3, pad='same', stride=1, nonlinearity=lasagne.nonlinearities.elu)
    net['conv_2_2_do'] = DropoutLayer(net['conv_2_2'], p=0.3)
    net['maxPool_2_2'] = Pool2DLayer(net['conv_2_2_do'], 2, mode='max')

    '''net['conv_3_1'] = ConvLayer(net['maxPool_2'], 64, 3, pad=1, stride=1)
    net['conv_3_1_do'] = DropoutLayer(net['conv_3_1'], p=0.3)
    net['conv_3_2'] = ConvLayer(net['conv_3_1'], 64, 3, pad=1, stride=1)
    net['conv_3_2_do'] = DropoutLayer(net['conv_3_2'], p=0.3)
    net['conv_3_3'] = ConvLayer(net['conv_3_2'], 64, 3, pad=1, stride=1)
    net['conv_3_3_do'] = DropoutLayer(net['conv_3_3'], p=0.3)
    net['maxPool_3'] = Pool2DLayer(net['conv_3_3'], 2, mode='max')'''

    net['fc_4'] = DenseLayer(net['maxPool_2_2'], 150, nonlinearity=lasagne.nonlinearities.elu)
