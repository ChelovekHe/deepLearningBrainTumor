...
EXPERIMENT_NAME = "segment_tumor_v0.1_deepresidualUnet_n_2"
...
net = build_deep_residual_UNet(4, BATCH_SIZE, num_output_classes=4, base_n_filters=16, n_res_blocks=2)
