...
learning_rate = theano.shared(np.float32(0.0001))
...
for epoch in range(n_epochs):
    ...
    train_loss_tmp = 0
    batch_ctr = 0
    for data, seg, labels in threaded_generator(memmapGeneratorDataAugm_t1km_flair_adc_cbv(train_pos_memmap, train_neg_memmap, BATCH_SIZE, n_pos_train, n_pos_train)):
    ...
    accuracies = []
    valid_batch_ctr = 0
    for data, seg, labels in threaded_generator(memmapGenerator_t1km_flair_adc_cbv(val_pos_memmap, val_neg_memmap, BATCH_SIZE, n_pos_val, n_pos_val)):
